...
当然还有很多容错方面的问题没有考虑到，如用户名密码错误怎么办，还有可以使用cookie来保存读取信息等等。接下里有时间慢慢改进吧。完整代码点击[这里](https://github.com/jeremybai/AutoLoginGateWay)，如果电脑上没有装python的同学，[这里](http://kuai.xunlei.com/d/ZmWaDoz8Ph3dUgQAef4)有打包成exe的程序，只要解压参考README运行即可。
### 注意： ###
