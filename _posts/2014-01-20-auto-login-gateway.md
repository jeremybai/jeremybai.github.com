...
### 前言 
之前有个朋友让我帮忙调试一个自动登录网关的程序，调了半天才能登陆网关。这两天又把代码重新拾起来review了下，增加了一些小功能。给大家介绍一下，也让自己重新再捋一遍。  
# 1 准备工作 
## 1.1 工作原理 
...
当然还有很多容错方面的问题没有考虑到，如用户名密码错误怎么办，还有可以使用cookie来保存读取信息等等。接下里有时间慢慢改进吧。完整代码点击[这里](https://github.com/jeremybai/AutoLoginGateWay)，如果电脑上没有装python的同学，点击这里[(32位系统)](http://kuai.xunlei.com/d/ZmWaDg4Bn-bdUgQAa94)和[(64位系统)](http://kuai.xunlei.com/d/ZmWaDg8Br-bdUgQAbd8)有打包成exe的程序，只要解压参考README运行即可。
### 注意： ###
