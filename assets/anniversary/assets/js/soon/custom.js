    ...
    **/
    ...
    function setDate(){
		...
		if( launch > now ){
			...
			//var s =  (launch.getTime() - (now.getTime() + now.getTimezoneOffset()*60*1000))/1000;
            var s = ((now.getTime() + now.getTimezoneOffset()*60*1000) - launch.getTime())/1000;
